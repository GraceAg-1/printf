...
--------------print hexal number in lower or upper-----------
/**
 * _printf- print hexal number in lower or upper
 * @types: List a of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
----------------------------Print hex number from upper or lower
/**
 * Printf- print from upper or lower
 * @types: Lista of arguments
 * @map_to: Array of values to map the number to
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
